...
const HeroSection = ({ onGetStarted, onSignIn }: HeroSectionProps) => {
  return (
    <section id="heroSection" className="relative py-20 lg:py-40">
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" onClick={onGetStarted} className="text-lg px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:bg-gradient-to-l">
